		...
		<section class="container mx-auto px-4 py-16">
			<div class="text-center mb-12">
				...
				<p class="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
					Revolutionary healthcare collaboration platform powered by blockchain technology.
					Secure medical data sharing, intelligent NFTs, and seamless collaboration between healthcare professionals.
				</p>
				<WalletConnect />
			</div>
		</section>
					...
					<div class="bg-white rounded-lg shadow-lg p-8 text-center">
						<div class="mb-6">
							<h2 class="text-3xl font-bold text-gray-900 mb-2">
								Welcome back, {currentUser.name || 'Healthcare Professional'}!
							</h2>
							<p class="text-gray-600">
								You are logged in as a <span class="font-semibold text-blue-600">{userRole?.replace('_', ' ').toUpperCase()}</span>
							</p>
						</div>
						...
						{#if getDashboardUrl()}
							<div class="mb-6">
								<p class="text-lg text-gray-700 mb-4">
									Ready to access your dashboard? Click below to continue to your personalized workspace.
								</p>
								<a
		...
		<section class="container mx-auto px-4 py-16">
			<div class="text-center mb-12">
				...
				<p class="text-gray-600 max-w-2xl mx-auto">
					Discover the powerful features that make MedNexus the leading healthcare collaboration platform
				</p>
			</div>
			...
			<div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
				<div class="bg-white rounded-lg shadow-lg p-6 text-center">
					...
					<p class="text-gray-600">Secure verification of medical credentials and documents using blockchain technology</p>
				</div>
				...
				<div class="bg-white rounded-lg shadow-lg p-6 text-center">
					...
					<p class="text-gray-600">Tokenize medical intelligence and research data as unique, tradable NFTs</p>
				</div>
				...
				<div class="bg-white rounded-lg shadow-lg p-6 text-center">
					...
					<p class="text-gray-600">Seamless collaboration between healthcare professionals and institutions</p>
				</div>
			</div>
		</section>
				...
				<div class="max-w-4xl mx-auto text-center">
					<div class="bg-white rounded-lg shadow-lg p-8">
						...
						<p class="text-gray-600 mb-6">
							Connect your wallet to access the MedNexus platform and explore your personalized healthcare dashboard.
						</p>
