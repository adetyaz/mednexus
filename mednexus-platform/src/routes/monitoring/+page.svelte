<script lang="ts">
	...
	import { systemMetrics, usageAnalytics, securityMetrics, monitoringService } from '$lib/services/monitoring';
				...
				<div class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-200">
					<div class="flex items-center">
						...
						<div class="ml-4">
							...
							<p class="text-2xl font-semibold text-gray-900">{$systemMetrics.totalTransactions.toLocaleString()}</p>
						</div>
					</div>
				</div>
				...
				<div class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-200">
					<div class="flex items-center">
						...
						<div class="ml-4">
							...
							<p class="text-2xl font-semibold text-gray-900">{$systemMetrics.crossBorderConsultations}</p>
						</div>
					</div>
				</div>
				...
				<div class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-200">
					<div class="flex items-center">
						...
						<div class="ml-4">
							...
							<p class="text-2xl font-semibold text-gray-900">{formatCurrency($systemMetrics.inftRevenue)}</p>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="space-y-4">
						<div class="flex items-center justify-between">
							...
							<div class="flex items-center gap-2">
								...
								<span class="text-sm font-medium">{formatPercentage($systemMetrics.systemUptime)}</span>
							</div>
						</div>
						
						<div class="flex items-center justify-between">
							<span class="text-sm text-gray-600">Average Response Time</span>
							<span class="text-sm font-medium">{$systemMetrics.averageResponseTime.toFixed(0)}ms</span>
						</div>
						...
						<div class="flex items-center justify-between">
							...
							<span class="flex items-center gap-1">
								...
								<span class="text-sm font-medium text-green-600">{$securityMetrics.dataEncryptionStatus}</span>
							</span>
						</div>
					</div>
				</div>
